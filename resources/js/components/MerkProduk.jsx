                    ...
                    {data.map((produk) => (
                        <div className="bg-white flex flex-col justify-between items-center pt-5 pb-8 border">
                            <div className="space-y-5 flex flex-col p-5">
                                ...
                                <h1></h1>
                                <h2 className="a text-md font-semibold font-raleway">
                                    {produk.merkproduk.merk_produk}
                                </h2>
                                <h4 className="text-sm font-raleway">{produk.jenisproduk.jenis_produk}</h4>
                                <h3 className="a text-md font-semibold font-raleway">
                                    {produk.nama_produk}
                                </h3>
                                <p className="text-md font-bold text-gray-900 dark:text-white font-poppins">
                                    Rp. {produk.harga}
                                </p>
                            </div>
                        </div>
