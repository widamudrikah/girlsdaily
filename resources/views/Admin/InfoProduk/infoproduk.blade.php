            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Informasi Produk</h3>
                        <div class="card-tools">
                            <div class="input-group input-group-sm" style="width: 250px;">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ route('infopr.baru') }}" class="btn btn-primary btn-sm">
                                        + Informasi
                                    </a>
                                </div>
                            </div>
                                ...
                                <tr>
                                    <td class="">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('infopr.edit', $row->id) }}" class="btn btn-secondary btn-sm"><i class="fa-solid fa-pencil"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#delete{{ $row->id }}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                        </div>
                                    </td>
                                    <td>{{ $row->produk->nama_produk }}</td>
                                    <td>{{ $row->information}}</td>
                                @include('Admin.InfoProduk.infopr-hapus')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
