    ...
    <div class="container">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mt-3">Nama Merk Produk</h5>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    @include('Admin.MerkProduk.updatemp')
                    @include('Admin.MerkProduk.hapusmp')
                    @endforeach
                </tbody>
            </table>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold" id="exampleModalLabel">Merk Produk</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('mp.tambah')}}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="merkproduk" class="form-label">Merk Produk</label>
                        <input type="text" required name="merk_produk" class="form-control" id="merkproduk">
                    </div>
            </div>
